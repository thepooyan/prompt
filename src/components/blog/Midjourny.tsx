...
// --- کامپوننت باکس نویسنده (انتهای مقاله) ---
function AuthorBox() {
  return (
    <div className="mt-16 pt-8 border-t border-gray-800">
      <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col md:flex-row items-center gap-6 hover:border-purple-500/30 transition duration-300 group">
        ...
        {/* عکس نویسنده */}
        <a href="/author/peyman" className="shrink-0 relative">
        ...
        <div className="text-center md:text-right flex-1">
          <h3 className="text-lg font-bold text-white mb-1">
            نویسنده: <a href="/author/peyman" className="hover:text-purple-400 transition">پیمان کلانتر نظری</a>
          </h3>
          ...
          <a href="/author/peyman" className="inline-flex items-center text-xs font-semibold text-purple-400 hover:text-purple-300 transition gap-1 px-3 py-1 bg-purple-500/10 rounded-full border border-purple-500/20 hover:bg-purple-500/20">
...
export default function MidjourneyGuide() {
  ...
  return (
    <div className="bg-gray-950 text-gray-100 min-h-screen font-[family-name:var(--font-vazirmatn)]">
      ...
      {/* کد اسکیما از اینجا حذف شد تا در GTM قرار گیرد */}
    </div>
  )
}