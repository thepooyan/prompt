            ...
            <div className="flex flex-col lg:flex-row gap-12">
                  ...
                  <nav className="space-y-2">
                    {tocItems.map((item) => (
                      <a
                        key={item.id}
                        href={`#${item.id}`}
                        className="block p-2 rounded text-muted-foreground hover:text-accent-foreground hover:bg-accent transition-colors"
                      >
                        • {item.title}
                      </a>
                    ))}
              ...
              <div className="flex-1 max-w-4xl">
                ...
                <section id="cta-section" className="text-center p-8 md:p-10 rounded-lg bg-gradient-to-br from-card to-card/50 border-2 border-primary/20 shadow-2xl shadow-primary/10 my-12 scroll-mt-20">
                  <h2 className="text-2xl font-bold mb-4">آیا می‌خواهید این ورک‌fلوها را آماده داشته باشید؟</h2>
                ...
                <section id="faq" className="scroll-mt-20">
                  ...
                  <Accordion type="single" collapsible defaultValue="f1" className="w-full">
                    {[
                      {
                        id: "f1",
